...
export const VOICE = {
  ...
  questFossil: "quest_fossil.mp3",
  questTest: "quest_test.mp3",
  questExcavation: "quest_excavation.mp3",
  partBrush: "part_brush.mp3",
  partHammer: "part_hammer.mp3",
  partMap: "part_map.mp3",
  partBone: "part_bone.mp3",
